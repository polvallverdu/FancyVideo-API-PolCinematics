...
import dev.polv.vlcvideo.api.mediaPlayer.AbstractMediaPlayer;
...
public final class MediaPlayerHandler {
    ...
    public synchronized void flagPlayerRemoval(DynamicResourceLocation resourceLocation) {
        VLCVideoEventBus.getInstance().runEvent(new PlayerRegistryEvent.RemovePlayerEvent(resourceLocation));
    }
     ...
     * @since 0.2.0.0
     */
    @VLCVideoEvent(priority = EventPriority.LOWEST, phase = EventPhase.EVENT)
